        ...
        btn_last.addEventListener("click", function () {
            if (ul.children.length > 0 && ul.children.length < 4) {
                ...
                a = setInterval(function () {
                    far();
                    ul_node.children[arr_lastA[j] - 1].style.backgroundColor = "rgb(56,136,173)";
            						   ul_node.children[arr_lastA[j] - 1].style.color = "white";
            ...
            if (ul.children.length > 3 && ul.children.length < 8) {
                ...
                a = setInterval(function () {
                    far(j);
                    ul_node.children[arr_lastB[j] - 1].style.backgroundColor = "rgb(56,136,173)";
            						   ul_node.children[arr_lastB[j] - 1].style.color = "white";
                    ul_last.children[j].style.display = 'block';
                    j = j + 1;
                }, 1500);
                function far(e) {
            ...
            if (ul.children.length > 7 && ul.children.length < 16) {
                ...
                a = setInterval(function () {
                    far(j);
                    ul_node.children[arr_lastC[j] - 1].style.backgroundColor = "rgb(56,136,173)";
            						   ul_node.children[arr_lastC[j] - 1].style.color = "white";
                    ul_last.children[j].style.display = 'block';
                    j = j + 1;
                }, 1500);
                function far(e) {
